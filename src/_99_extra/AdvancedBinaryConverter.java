...
public class AdvancedBinaryConverter implements ActionListener {
	...
	public void start() {
		...
		//    of the panel and span 2 columns, 
	...
	public void actionPerformed(ActionEvent arg0) {
		...
		String field = inputTextField.getText();	
		String ascii = binaryToAscii(field);
		asciiResult.setText(ascii);
		String btoint = binaryToInt(field);
		decimalResult.setText(btoint);
		String btohex = binaryToHex(field);
		hexResult.setText(btohex);
